...
save(stan.mod.2,file = './data/stan_procedual_model_6.rda')

# Warning messages:
#   1: There were 2250 transitions after warmup that exceeded the maximum treedepth. Increase max_treedepth above 13. See
...
saveRDS(theta.pe, "./data/stan_procedual_6.rds")
